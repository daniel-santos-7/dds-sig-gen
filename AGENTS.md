...
- Override frequency, phase, and amplitude at the command line:

  ```bash
  make run FREQ_HZ=1000000 PHASE_DEG=45 AMP_VAL=1024
  ```
  
  `AMP_VAL` is the amplitude deviation from center (0–2047). The internal register is calculated as `AMP_VAL + 2048`.
